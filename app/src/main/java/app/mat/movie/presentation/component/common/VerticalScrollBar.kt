...
fun Modifier.listVerticalScrollBar(
    ...
    val scrollBarHeight by animateFloatAsState(currentScrollBarHeight, label = "")
    val scrollbarOffsetY by animateFloatAsState(currentScrollbarOffsetY, label = "")
